...
bool VulkanManager::CreateRenderingResources() {
...
bool VulkanManager::CreateCommandPool(uint32_t queue_family_index, VkCommandPool *pool) {
...
bool VulkanManager::AllocateCommandBuffers(VkCommandPool pool, uint32_t count, VkCommandBuffer *command_buffers) {
...
bool VulkanManager::CreateStagingBuffer() {
...
bool VulkanManager::CreateBuffer(VkBufferUsageFlags usage, VkMemoryPropertyFlagBits memoryProperty, BufferParameters &buffer) {
...
bool VulkanManager::AllocateBufferMemory(VkBuffer buffer, VkMemoryPropertyFlagBits property, VkDeviceMemory *memory) {
...
bool VulkanManager::CreateTexture() {
...
bool VulkanManager::CreateImage(uint32_t width, uint32_t height, VkImage *image) {
...
bool VulkanManager::AllocateImageMemory(VkImage image, VkMemoryPropertyFlagBits property, VkDeviceMemory *memory) {
...
bool VulkanManager::CreateImageView(ImageParameters &image_parameters) {
...
bool VulkanManager::CreateSampler(VkSampler *sampler) {
...
bool VulkanManager::CopyTextureData(char *texture_data, uint32_t data_size, uint32_t width, uint32_t height) {
...
const std::array<float, 16> VulkanManager::GetUniformBufferData() const {
...
bool VulkanManager::CopyUniformBufferData() {
	// Prepare data in staging buffer
...
bool VulkanManager::AllocateDescriptorSet() {
...
bool VulkanManager::UpdateDescriptorSet() {
...
bool VulkanManager::CreatePipelineLayout() {
...
bool VulkanManager::CreatePipeline() {
...
AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule> VulkanManager::CreateShaderModule(const char* filename) {
...
const std::vector<float>& VulkanManager::GetVertexData() const {
...
bool VulkanManager::CopyVertexData() {
	// Prepare data in staging buffer
	const std::vector<float>& vertex_data = GetVertexData();
...
bool VulkanManager::PrepareFrame(VkCommandBuffer command_buffer, const ImageParameters &image_parameters, VkFramebuffer &framebuffer) {
...
bool VulkanManager::CreateFramebuffer(VkFramebuffer &framebuffer, VkImageView image_view) {
...
bool VulkanManager::ChildOnWindowSizeChanged() {
	if ((GetDevice() != VK_NULL_HANDLE) &&
...
void VulkanManager::ChildClear() {
}

void VulkanManager::DestroyBuffer(BufferParameters& buffer) {
