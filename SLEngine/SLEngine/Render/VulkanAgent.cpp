...
VulkanAgent* VulkanAgent::GetInstance()
{
	static VulkanAgent s_cVulkanAgent;
	return &s_cVulkanAgent;
}

VulkanAgent::VulkanAgent()
{
}
...
bool VulkanAgent::init(WindowParameters parameters)
{
	Window = parameters;
...
bool VulkanAgent::CreateRenderingResources() {
...
bool VulkanAgent::CreateCommandBuffers() {
...
bool VulkanAgent::CreateCommandPool(uint32_t queue_family_index, VkCommandPool *pool) {
...
bool VulkanAgent::AllocateCommandBuffers(VkCommandPool pool, uint32_t count, VkCommandBuffer *command_buffers) {
...
bool VulkanAgent::CreateSemaphores() {
...
bool VulkanAgent::CreateStagingBuffer() {
...
bool VulkanAgent::CreateBuffer(VkBufferUsageFlags usage, VkMemoryPropertyFlagBits memoryProperty, BufferParameters &buffer) {
...
bool VulkanAgent::AllocateBufferMemory(VkBuffer buffer, VkMemoryPropertyFlagBits property, VkDeviceMemory *memory) {
...
bool VulkanAgent::CreateTexture() {
	int width = 0, height = 0, data_size = 0;
	std::vector<char> texture_data = GetImageData("Data06/texture.png", 4, &width, &height, nullptr, &data_size);
...
bool VulkanAgent::CreateImage(uint32_t width, uint32_t height, VkImage *image) {
...
bool VulkanAgent::AllocateImageMemory(VkImage image, VkMemoryPropertyFlagBits property, VkDeviceMemory *memory) {
...
bool VulkanAgent::CreateImageView(ImageParameters &image_parameters) {
...
bool VulkanAgent::CreateSampler(VkSampler *sampler) {
...
bool VulkanAgent::CopyTextureData(char *texture_data, uint32_t data_size, uint32_t width, uint32_t height) {
...
bool VulkanAgent::CreateUniformBuffer() {
...
const std::array<float, 16> VulkanAgent::GetUniformBufferData() const {
...
bool VulkanAgent::CopyUniformBufferData() {
	// Prepare data in staging buffer
...
bool VulkanAgent::CreateDescriptorSetLayout() {
...
bool VulkanAgent::CreateDescriptorPool() {
...
bool VulkanAgent::AllocateDescriptorSet() {
...
bool VulkanAgent::UpdateDescriptorSet() {
...
bool VulkanAgent::CreateRenderPass() {
...
bool VulkanAgent::CreatePipelineLayout() {
...
bool VulkanAgent::CreatePipeline() {
	AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule> vertex_shader_module = CreateShaderModule("Data07/vert.spv");
	AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule> fragment_shader_module = CreateShaderModule("Data07/frag.spv");
...
AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule> VulkanAgent::CreateShaderModule(const char* filename) {
	...
	return AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule>(shader_module, vkDestroyShaderModule, GetDevice());
}

bool VulkanAgent::CreateVertexBuffer() {
...
const std::vector<float>& VulkanAgent::GetVertexData() const {
...
bool VulkanAgent::CopyVertexData() {
	// Prepare data in staging buffer
	const std::vector<float>& vertex_data = GetVertexData();
...
bool VulkanAgent::PrepareFrame(VkCommandBuffer command_buffer, const ImageParameters &image_parameters, VkFramebuffer &framebuffer) {
...
bool VulkanAgent::CreateFramebuffer(VkFramebuffer &framebuffer, VkImageView image_view) {
...
bool VulkanAgent::ChildOnWindowSizeChanged() {
	if ((GetDevice() != VK_NULL_HANDLE) &&
...
void VulkanAgent::ChildClear() {
}

void VulkanAgent::DestroyBuffer(BufferParameters& buffer) {
